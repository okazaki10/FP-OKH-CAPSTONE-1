...
public class CourseData {
    ...
    public CourseData(String fileInput) {
        // menbaca dataset dan memasukkan ke dalam arraylist
        try {
    ...
    public int[][] getConflictMatrix() throws IOException {
        ...
        // membuat matrix yang menyimpan jumlah konflik antar course
    ...
    public static int[][] sortByDegree(int[][] conflictMatrix, int jumlahCourse) {
        // membuat tabel untuk menyimpan course dan degree
        ...
        // sort largest degree secara ascending
